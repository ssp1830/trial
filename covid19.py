...
if analysis=="Vaccination report":
    ...
    type=px.pie(India_status,names=["Total Covaxin Administered","Total CoviShield Administered"], values=vact, color_discrete_sequence=px.colors.sequential.Magma)
